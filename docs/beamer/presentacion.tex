...
\begin{itemize}
\item {\bf Experimento 1:}:Con el fin de verificar la precisión del algoritmo propuesto, se ejecuta con los mismos valores y la misma función tres veces si los resultados coinciden significará que es exacto.\pause
...
\item {\bf Experimento 5:}: Para determinar el rendimiento del algoritmo, se introduce un cronómetro en el mismo de forma que imprimiera el tiempo que tarda la CPU de la computadora en ejecutar el programa.
\end{itemize}
\end{frame}
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
